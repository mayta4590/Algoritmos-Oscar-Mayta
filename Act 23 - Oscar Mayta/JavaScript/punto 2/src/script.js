...
function revisarSospechosa(tipo, monto, id_mov, lista2) {
...
function procesarTransacciones() {
    ...
    for (let x = 0; x < num; x++) {
        ...
        revisarSospechosa(tipo, monto, id_mov, lista2);
    }
